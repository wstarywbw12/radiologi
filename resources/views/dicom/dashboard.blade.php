                ...
                <div class="card card-stats shadow-sm border-0">
                    <div class="card-body bg-primary text-white rounded-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="card-title mb-2">Total Data</h6>
                                <h2 class="display-6 mb-0">{{ $total }}</h2>
                            </div>
                            <div>
                                <i class="bi bi-database fs-1"></i>
                            </div>
                        </div>
                        <small class="mt-2 d-block">Total seluruh data DICOM</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card card-stats shadow-sm border-0">
                    <div class="card-body bg-success text-white rounded-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="card-title mb-2">Sent</h6>
                                <h2 class="display-6 mb-0">{{ $sent }}</h2>
                            </div>
                            <div>
                                <i class="bi bi-check-circle fs-1"></i>
                            </div>
                        </div>
                        <small class="mt-2 d-block">Data berhasil terkirim</small>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body bg-danger text-white rounded-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h2 class="display-6 mb-0">{{ $pending }}</h2>
                            </div>
                            <div>
                                <i class="bi bi-clock-history fs-1"></i>
                            </div>
                        </div>
                        <small class="mt-2 d-block">Data menunggu proses</small>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    @forelse($recent as $index => $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->requested_procedure_description ?? '-' }}</td>
                                            <td>{{ $row->modality ?? '-' }}</td>
                                            <td>{{ $row->referring_phyisician_name ?? '-' }}</td>
                                            <td>
